...
void objetos() {
  ...
  mundo.add(objeto30);
  bolaPendulo = new FCircle(30);
  bolaPendulo.setPosition(400, 350);
  bolaPendulo.setStrokeWeight(grosorLinea);
  bolaPendulo.setDensity(6);
  mundo.add(bolaPendulo);
  FDistanceJoint cadena = new FDistanceJoint(objeto30, bolaPendulo);
